...
cat <<EOF | tee -a /home/${USERNAME}/.bash_aliases > /dev/null
if [[ ":\${PATH}:" != *":/home/${USERNAME}/bin:"* ]]; then
  export PATH=\${PATH}:/home/${USERNAME}/bin
fi
EOF

echo "PS1='[\[\033[1;32m\]\u\[\033[m\]@\[\033[1;35m\]\h\[\033[m\] \[\033[1;34m\]\W\[\033[m\]]\$ '" | tee -a /home/${USERNAME}/.bash_aliases > /dev/null
